...
(function(window) {
    ...
    */
    ...
    var settings = {
        ...
        // Websocket settings
        wsHost: "ws://127.0.0.1:8001/websocket",
        psk: "echo-protocol",
    ...
    function start(loc, psk) {
        ...
        webSocket.onclose = function() {
            ...
            d3.select("#events-data").selectAll("tr.row").remove(); 
            d3.select("#events-data").append("tr").attr('class', 'row').html("<td colspan='7'><img src='/static/css/d3/images/loading.gif' style='margin-top: 6px;'/>&nbsp;<span style='display: inline-block; height: 25px; vertical-align: middle;'>Loading...</span></td>");
     ...
     */
    queue()
     .defer(d3.json, "/static/d3/china_cities.json")
     .defer(d3.json, "/static/d3/china_provinces.json")
     .defer(d3.csv, "/static/d3/country-codes.csv")
